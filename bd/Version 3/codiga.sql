...
CREATE TABLE IF NOT EXISTS `codiga`.`cabeza_ganado` (
  ...
  `raza_padre` VARCHAR(45) NULL,
  `raza_madre` VARCHAR(45) NULL,
  `codigo_padre` INT NULL,
  `codigo_madre` INT NULL,
...
CREATE TABLE IF NOT EXISTS `codiga`.`geo_posicion` (
  ...
  `temp` FLOAT NULL COMMENT 'temperatura de la vaca\n',
  `accel` INT NULL COMMENT 'Movimiento total de la vaca',
  `bat_level` INT NULL COMMENT 'Nivel de la bateria',
  `bat_temp` INT NULL,
  `status` SET('0', '1') NULL,
...
CREATE TABLE IF NOT EXISTS `codiga`.`ctrl_vacunas` (
  ...
  `costo` INT NULL,
  `ctrl_vacunascol` VARCHAR(45) NULL,
  `cabeza_ganado_id_cabeza` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `codiga`.`ctrl_reproductivo` (
  ...
  `num_nacidos` INT NULL,
  `num_muertos` INT NULL,
  `tipo` VARCHAR(45) NULL COMMENT 'Inseminación o Monta',
  `cabeza_ganado_id_cabeza` INT NOT NULL,

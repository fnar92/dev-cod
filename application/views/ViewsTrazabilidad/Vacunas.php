                    ...
                    <td>
                        <div class="row">
                            <div class="box-option"><div class="squaredFour">
                                    <input type="checkbox" class="cows" id="<?php echo $row->id_cabeza; ?>" name="<?php echo $row->id_cabeza; ?>" value="<?php echo $row->id_cabeza; ?>" onclick="mycheck('<?php echo $row->id_cabeza ?>')">

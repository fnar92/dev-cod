...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyD0jaZy6edBz_ZQLtcIlGQqBHufL9ekmq8'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	var $center						= "22.6021222,-120.7764465";		// Sets the default center location (lat/long co-ordinate or address) of the map. If defaulting to the users location set to "auto"
	...
	var $disableMapTypeControl		= TRUE;					// If set to TRUE will hide the MapType control (ie. Map, Satellite, Hybrid, Terrain)
	var $disableNavigationControl	= TRUE;					// If set to TRUE will hide the Navigation control (ie. zoom in/out, pan)
	var $disableScaleControl		= TRUE;					// If set to TRUE will hide the Scale control
	var $disableStreetViewControl	= TRUE;					// If set to TRUE will hide the Street View control
	...
	function add_marker($params = array())
	{
		...
		$marker['icon'] = 'http://i.imgur.com/InRJwTy.png';		// The name or url of the icon to use for the marker
	...
	function add_polygon($params = array())
	{
		...
		$polygon['strokeColor'] = '#663300';					// The hex value of the polygons border color
		...
		$polygon['fillColor'] = '#663300';						// The hex value of the polygons fill color
